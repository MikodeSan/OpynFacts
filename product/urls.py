...
urlpatterns = [
    ...
    path(
        "product/<int:product_id>/from/<str:page_origin>", views.product, name="product"
    ),
    path(
        "product/<int:product_id>/from/<str:page_origin>/<str:product_id_origin>/<str:user_query>",
        views.product,
        name="product",
    ),
